        ...
        <AppBar position="static" style={{backgroundColor:'#39424e'}}>
          <Toolbar >
            <Typography variant="title"  color="inherit" className={[classes.flex, classes.middle]}>
              <Header className="header-color" style={{backgroundColor:'#39424e'}} title={<div style={{ textDecoration: 'none', color: 'white'}}><i class ="cicon"></i><span className="logo">{"{C}"}</span>CodeChallenge</div>} scroll></Header>
            </Typography>
            ...
            {auth && (
              <div>
                ...
                >                  
                  ...
                  <Link to="login"><MenuItem onClick={this.handleClose}>LogOut</MenuItem></Link>
                </Menu>
              </div>
            )}
          </Toolbar>
